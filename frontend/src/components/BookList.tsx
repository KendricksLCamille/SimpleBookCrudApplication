...
export default function BookList(props: Readonly<{ setState: React.Dispatch<React.SetStateAction<State>> }> | ((s: {
    ...
    const bookProperties: ("title" | "author" | "publishedDate" | "genre" | "rating")[] = ['title', 'author', 'publishedDate', 'genre', 'rating'];
...
function sortBooks(books: Book[], sortBy: "title" | "author" | "publishedDate" | "genre" | "rating"): Book[] {
